...
<template>
    <div class="mx-auto flex w-full min-h-0 flex-col gap-4 p-6">
        <header
            ...
            <div class="flex items-center gap-3 justify-self-end">
                ...
                <button type="button" aria-label="Log out" title="Log out" @click="logout"
        ...
        <div class="grid min-h-0 flex-1 gap-4 lg:grid-cols-2">
            ...
            <div class="flex min-h-0 flex-col justify-center gap-4">
                <div :class="panelClass">
                    ...
                    <button v-if="!created" type="button" :disabled="busy" @click="createGame"
                    ...
                    <template v-else>
                        <div class="flex flex-col gap-2">
                            ...
                            <p class="text-sm text-gray-x-light">
                                Share this code. The table appears on the right.
                            </p>
                        </div>

                        <button type="button" @click="created = null"
                    ...
                    <li v-for="game in activeGames" :key="game.id"
                     ...
                     at a glance, and the thing that visibly changes on poll -->
                                <div class="flex items-center gap-1.5 my-1">
                                    <SeatToken v-for="i in game.maxPlayers" :key="i"
                        ...
                        <div class="flex gap-2">
                            ...
                            <button type="button" :disabled="busy" :class="[
                                dangerBtn,
            ...
            -->
                        <div v-if="isConfirming(game.joinCode, 'destroy') && canDelete(game)"
                            ...
                            <button type="button" :disabled="busy" @click="doDelete(game.joinCode)"
                                ...
                                <span
                                    class="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg border-2 border-rose-400/50 bg-rose-400/15 text-rose-400">🗑</span>
                                <span class="flex min-w-0 flex-col">
                        ...
                        <div v-else-if="isConfirming(game.joinCode, 'destroy')"
                            ...
                            <button type="button" :disabled="busy" @click="doLeave(game.joinCode)"
