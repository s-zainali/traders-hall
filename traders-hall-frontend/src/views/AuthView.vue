    ...
    <main class="flex flex-1 items-center justify-center px-6 py-4">
      <div class="flex w-full max-w-md flex-col gap-8">
        ...
        >
          ...
          <div
            class="relative grid grid-cols-2 rounded-xl border-2 border-gray-light bg-gray-dark/60 p-1"
          >
            <div
              class="absolute inset-y-1 w-[calc(50%-0.25rem)] rounded-lg bg-teal-light transition-transform duration-300 ease-out"
