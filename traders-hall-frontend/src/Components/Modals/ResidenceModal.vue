  ...
  >
    ...
    <template v-if="isLet">
      ...
      <footer class="flex items-center justify-between gap-3 border-t-1 border-gray-light pt-4">
        ...
        <button
          type="button"
          :class="[actionButton, tealBtn, 'ml-auto']"
    ...
    <template v-else>
      ...
      >
        ...
        <button
          type="button"
          :class="[actionButton, purpleBtn, 'w-full']"
          :disabled="locked || !moveTarget"
      ...
      <section v-if="isHoused" class="flex flex-col gap-2 border-t-1 border-gray-light pt-4">
        <template v-if="!isTenant">
          <button
            type="button"
            :class="[actionButton, ghostBtn, 'w-full']"
            :disabled="locked"
            @click="emit('leave')"
          >
            Vacate
        ...
        <template v-else-if="wasRefused">
          ...
          >
            <span class="text-[10px] font-bold uppercase tracking-widest text-rose-400"
              >Refused</span
            >
          ...
          <div class="flex gap-2">
            <button
              type="button"
              :class="[actionButton, ghostBtn, 'flex-1']"
              :disabled="locked"
            ...
            <button
              type="button"
              :class="[actionButton, tealBtn, 'flex-1']"
              :disabled="locked || !canAffordBuyout"
              @click="emit('resolveMoveOut', true)"
            >
              Pay {{ moveoutBuyout }}
            </button>
          </div>
      ...
      <section v-if="tenants.length" class="flex flex-col gap-2 border-t-1 border-gray-light pt-4">
        ...
        >
          ...
          <div v-if="t.moveoutStatus === 'requested'" class="flex gap-2">
            <button
              type="button"
              :class="[actionButton, ghostBtn, 'flex-1 py-1.5 text-xs']"
              :disabled="busy"
            ...
            <button
              type="button"
              :class="[actionButton, tealBtn, 'flex-1 py-1.5 text-xs']"
              :disabled="busy"
          ...
          <button
            v-else
            type="button"
            :class="[actionButton, ghostBtn, 'w-full py-1.5 text-xs']"
            :disabled="busy"
            @click="emit('evict', t.agreementId)"
          >
