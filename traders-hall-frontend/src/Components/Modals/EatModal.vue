...
const canConfirm = computed(() => !props.busy && nutrition.value > 0)
...
const eatClass = 'bg-cream-light text-gray-dark border-2 border-cream-light hover:brightness-110'
</script>
...
<template>
  ...
  >
    ...
    >
      ...
      <p
        class="rounded-xl border-2 border-cream-light/40 bg-cream-light/10 px-4 py-2 text-center text-sm font-bold text-gray-2x-light"
      >
        {{ title }}
