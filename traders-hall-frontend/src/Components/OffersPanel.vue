            ...
            <li v-for="offer in rows" :key="offer.id"
                ...
                <div v-else class="flex items-center gap-2">
                    ...
                    <svg class="h-4 w-4 shrink-0" viewBox="0 0 16 16" fill="none" stroke="currentColor"
                        ...
                        :class="offer.isSell ? 'text-rose-400' : offer.isRent ? 'text-teal-light' : 'text-amber-400'">
                        <path d="M2.5 8h11M9.5 4 13.5 8l-4 4" />
                    </svg>
                ...
                <div class="flex items-center gap-1.5">
                    <template v-for="(label, i) in STEPS" :key="label">
                        <span class="h-1.5 w-1.5 shrink-0 rounded-full transition-colors duration-300"
                            :class="i <= offer.step ? (i === 1 ? 'bg-amber-400' : 'bg-teal-light') : 'bg-gray-light'"></span>
                ...
                <button v-else-if="offer.claimedByMe" type="button" :disabled="busy"
